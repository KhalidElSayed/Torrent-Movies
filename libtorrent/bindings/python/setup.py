...
extra_cmd = '-DBOOST_ASIO_HASH_MAP_BUCKETS=1021 -DTORRENT_USE_OPENSSL -DWITH_SHIPPED_GEOIP_H -DBOOST_EXCEPTION_DISABLE   -pthread -I/usr/local/include -lz  -lboost_filesystem-mt -lboost_thread-mt  -lssl -lcrypto -lboost_system-mt -L/usr/lib -I/usr/include/openssl -DHAVE_SSL'
...
setup( name='python-libtorrent',
	...
	ext_modules = [Extension('libtorrent',
		...
		extra_link_args = ' -L/usr/local/lib'.split() + arch(),
