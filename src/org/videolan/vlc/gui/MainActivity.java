...
import com.PPinera.Torrent_Movies.Activities.TorrentSelectActivity;
...
public class MainActivity extends SherlockFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		if (OLD_VLC) {
	        ...
	        View v_main = LayoutInflater.from(this).inflate(R.layout.vlc_main, null);
        ...
        if (!OLD_VLC) {
			Intent i = new Intent(this, TorrentSelectActivity.class);
			startActivity(i);
			finish();
		}
    }
